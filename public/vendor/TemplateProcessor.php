...
class TemplateProcessor
{
	...
	{
		preg_match('/(<w:body>)(.*)(<w:sectPr)/is', $this->tempDocumentMainPart, $output_array);
		// preg_match('/(<w:body>)(.*)(<\/w:body>)/is', $this->tempDocumentMainPart, $output_array);
    ...
    private function processBlock(
        ...
        $startBlockStart = $this->findOpenTagLeft($this->tempDocumentMainPart, '<w:r>', $startTagPos, $throwException);
        $startBlockEnd = $this->findCloseTagRight($this->tempDocumentMainPart, '</w:r>', $startTagPos);
        ...
        $endBlockStart = $this->findOpenTagLeft($this->tempDocumentMainPart, '<w:r>', $endTagPos, $throwException);
        $endBlockEnd = $this->findCloseTagRight($this->tempDocumentMainPart, '</w:r>', $endTagPos);
